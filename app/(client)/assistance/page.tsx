...
export default function AssistancePage() {
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 h-[calc(100vh-120px)]">
      {/* HEADER */}
      <section className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          ...
          <p className="text-xs md:text-sm text-sbc-muted max-w-xl mt-2 leading-relaxed">
            ...
            <span className="text-sbc-gold font-semibold">bot</span> répond aux
            demandes courantes, et un{" "}
        ...
        <div className="rounded-2xl border border-sbc-border/60 bg-sbc-bgSoft/70 px-4 py-3 text-[11px] md:text-xs text-sbc-muted max-w-xs">
      ...
      {/* BLOC CHAT */}
      <section className="flex-1 flex flex-col bg-sbc-bgSoft/70 border border-sbc-border rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.9)] overflow-hidden">
        {/* En-tête du chat */}
        <div className="px-4 md:px-6 py-3 border-b border-sbc-border/60 flex items-center justify-between">
        ...
        <div className="border-t border-sbc-border/60 px-4 md:px-6 py-3 bg-sbc-bgSoft/80">
          ...
          <div className="flex items-end gap-2">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-2xl px-4 py-2 text-xs md:text-sm font-semibold border border-sbc-gold bg-sbc-gold text-sbc-bgSoft disabled:opacity-50 disabled:cursor-not-allowed hover:bg-sbc-goldSoft hover:text-sbc-bg transition"
            >
              {loading ? "Envoi…" : "Envoyer"}
            </button>
          </div>
          <p className="mt-1 text-[10px] text-sbc-muted">
            Appuyez sur <span className="font-semibold">Entrée</span> pour
            envoyer, <span className="font-semibold">Maj + Entrée</span> pour
            aller à la ligne.
          </p>
        </div>
      </section>
