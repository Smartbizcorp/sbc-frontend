      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col gap-8 md:gap-10">
        ...
        <section className="bg-sbc-bgSoft/70 border border-sbc-border rounded-3xl p-5 md:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.9)] text-xs md:text-sm text-sbc-muted leading-relaxed space-y-5">
          <p className="text-[11px] md:text-xs text-sbc-muted/80 italic">
            {/* Texte intro optionnel / date de mise à jour si besoin */}
          </p>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                Suivi de vos investissements, calcul des performances, affichage des
                soldes, gains et retraits.
              </li>
              <li>
              ...
              <li>
                Amélioration continue de la plateforme, statistiques d&apos;usage et
                prévention de la fraude ou des comportements abusifs.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                l&apos;exécution d&apos;un contrat : gestion de votre compte client et
                des opérations d&apos;investissement ;
              </li>
              <li>
                le respect d&apos;obligations légales et réglementaires, notamment en
                matière de lutte contre la fraude et de conformité ;
              </li>
              <li>
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              la relation contractuelle, augmentée des délais de prescription
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              données personnelles, vous disposez notamment des droits suivants
            ...
            <p className="mt-2">
              ...
              d&apos;assistance via l&apos;espace client ou par tout moyen de contact
              indiqué dans la rubrique Assistance. Une réponse vous sera apportée
              dans les meilleurs délais, conformément au cadre légal applicable.
            </p>
          </div>
