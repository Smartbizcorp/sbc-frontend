...
export default function MentionsLegalesPage() {
  return (
    <div className="w-full max-w-4xl mx-auto px-3 sm:px-4 md:px-0 py-6 sm:py-8">
      {/* Header */}
      <section className="bg-sbc-bgSoft/60 border border-sbc-border rounded-3xl p-5 sm:p-6 md:p-6 shadow-[0_18px_45px_rgba(0,0,0,0.85)]">
        ...
        <p className="mt-2 text-xs sm:text-sm text-sbc-muted leading-relaxed">
          Version <span className="text-sbc-text">{LEGAL_VERSION}</span> —
          Mise à jour : <span className="text-sbc-text">{EFFECTIVE_DATE}</span>
        </p>
